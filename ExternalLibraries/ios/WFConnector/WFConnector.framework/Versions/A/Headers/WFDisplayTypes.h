...
typedef enum
{
    WF_DISPLAY_FONT_SYSTEM10        = 0x00,     // RFLKT, Timex x50 (caps only)
    WF_DISPLAY_FONT_SYSTEM19        = 0x01,     // RFLKT
    WF_DISPLAY_FONT_SYSTEM26        = 0x02,     // RFLKT, Timex x50 (caps only)
    WF_DISPLAY_FONT_SYSTEM33        = 0x03,     // RFLKT
    WF_DISPLAY_FONT_SYSTEM48        = 0x04,     // RFLKT
    
    
    WF_DISPLAY_FONT_SYSTEM12        = 0x05,     // Echo, Timex x50 (full set)
    WF_DISPLAY_FONT_SYSTEM14        = 0x06,     // Echo, Timex x50 (caps only)
    ...
    WF_DISPLAY_FONT_SYSTEM39        = 0x1C,     // Timex x50 (caps only)
